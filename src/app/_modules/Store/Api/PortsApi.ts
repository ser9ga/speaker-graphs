...
const entityCategoryName = ENTITY_CATEGORY_NAME.PORTS;
const entityLabel = ENTITY_NAME_LABEL[ENTITY_NAME.PORT];
const entityCategoryLabel = ENTITY_CATEGORY_NAME_LABEL[ENTITY_CATEGORY_NAME.PORTS];
const baseUrl = '/api';
