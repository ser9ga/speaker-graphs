...
const entityCategoryName = ENTITY_CATEGORY_NAME.CARS;
const entityLabel = ENTITY_NAME_LABEL[ENTITY_NAME.CAR];
const entityCategoryLabel = ENTITY_CATEGORY_NAME_LABEL[ENTITY_CATEGORY_NAME.CARS];
const baseUrl = '/api';
