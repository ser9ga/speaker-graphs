...
const entityCategoryName = ENTITY_CATEGORY_NAME.CABINETS;
const entityLabel = ENTITY_NAME_LABEL[ENTITY_NAME.CABINET];
const entityCategoryLabel = ENTITY_CATEGORY_NAME_LABEL[ENTITY_CATEGORY_NAME.CABINETS];
const baseUrl = '/api';
const reducerPath = entityCategoryName;
const basePath = `entities/${entityCategoryName}`;
const tags = [entityCategoryName];

export const cabinetsApi = createApi({
  reducerPath: reducerPath,
  baseQuery: fetchBaseQuery({ baseUrl }),
  tagTypes: tags,
  endpoints: (build) => ({
    getAllCabinets: build
