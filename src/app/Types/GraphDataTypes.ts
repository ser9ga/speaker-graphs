import { MeasuredUnit } from '@/app/Constants/MeasuredUnit';

export type MeasureFrame = Record<MeasuredUnit, number | string | null>
...
export type GraphData = Record<number, MeasureFrame>
